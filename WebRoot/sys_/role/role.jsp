...
<html>
  <head>
    ...
    <title>角色授权</title> 
    <script type="text/javascript" src="/wisdoorStatic/js/tree/dhtmlXTree/dhtmlxcommon.js"></script>
    <script type="text/javascript" src="/wisdoorStatic/js/tree/dhtmlXTree/dhtmlxtree.js"></script>
	<link rel="stylesheet" type="text/css" href="/wisdoorStatic/js/tree/dhtmlXTree/dhtmlxtree.css">
  ...
  <body>
    ...
    <script type="text/javascript">  
		...
		tree.setImagePath('/wisdoorStatic/js/tree/dhtmlXTree/imgs/csh_bluebooks/');
