...
<link href="/wisdoorStatic/js/tree/tabletree/styles.css" rel="stylesheet" type="text/css" />
<%@ include file="/common/taglib.jsp" %>
<%@ include file="/common/import.jsp" %>
<script type="text/javascript" src="/wisdoorStatic/js/autoheight.js"></script>
<script type="text/javascript" src="/wisdoorStatic/js/tree/tabletree/jquery.treetable.js"></script>
...
$(document).ready(function(){  
		$.treetable.defaults={
			...
			open_img:"/wisdoorStatic/js/tree/tabletree/images/minus.gif",
			close_img:"/wisdoorStatic/js/tree/tabletree/images/plus.gif"
		};
...
<!-- 				
		...
		<c:forEach items="${pageView.records}" var="org">
			<tr> 
				...
				<td>${org.shortName}</td>
				<td><c:if test="${org.type == 0}">总公司</c:if>
				    <c:if test="${org.type == 1}">服务中心</c:if>
				    <c:if test="${org.type == 2}">经销商</c:if>
				</td>
