...
<html>
	<head> 
		<title>角色</title>
 <script type="text/javascript" src="/wisdoorStatic/js/tree/selecttree/jstree/css.js"></script>
<script src="/wisdoorStatic/js/tree/selecttree/jstree/tree_component.js" type="text/javascript"></script>
<script src="/wisdoorStatic/js/tree/selecttree/common.js" type="text/javascript"></script>
<link rel="stylesheet" type="text/css" href="/wisdoorStatic/js/tree/selecttree/jstree/tree_component.css" />
<script type="text/javascript" src="/wisdoorStatic/js/tree/selecttree/jstree/css.js"></script>  
...
<script type="text/javascript" src="/wisdoorStatic/js/validate/jquery.metadata.js"></script> 
