...
<body>
	<form id="form1" action="/back/product/productAction!list"
		method="post">
		...
		<div id="myToolBar"
			...
			<div style="float: right; margin-right: 20px;">
				<button class="ui-state-default"
					onclick="toURL('/back/product/productAction!edit?modify=false');return false;"
                    style="display:<c:out value="${menuMap['product_edit']}"/>">
					新增
				</button>
				&nbsp;
			</div>
				...
				<tbody class="table_solid">
					<c:forEach items="${pageView.records}" var="product">
						<tr>
							...
							<td>
								<button class="ui-state-default"
									onclick="toURL('/back/product/productAction!edit?modify=true&id=${product.id}');return false;"
									style="display:<c:out value="${menuMap['product_edit']}" />">
									修改
								</button>
