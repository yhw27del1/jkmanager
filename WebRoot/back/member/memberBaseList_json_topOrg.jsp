	...
	<body>
		<table id="dg" class="easyui-datagrid"
	        ...
	        <thead data-options="frozen:true">
	        	<tr>
                    <th data-options="field:'CODE',width:80" rowspan="2">用户名</th>
                    <th data-options="field:'PNAME',width:100" rowspan="2">会员姓名</th>
                    <th data-options="field:'FUDAOREN',width:100" rowspan="2">辅导人</th>
                </tr>
	        </thead>
	        <thead>
	            <tr>
	                <th data-options="field:'CREATOR',width:100" rowspan="2">介绍人</th>
	                <th data-options="field:'PMOBILE',width:100" rowspan="2">联系电话</th>
	                 <th data-options="field:'EMAIL',width:100" rowspan="2">电子邮件</th>            
                    <th data-options="field:'PROVINCENAME',width:100,formatter:area_formatter" rowspan="2">所在区域</th>
                    <th data-options="field:'CATEGORY',width:100,formatter:member_type_formatter" rowspan="2">类别</th>
	    ...
	    <div id="tb" style="padding:5px;height:auto">
	        <div>
	           &nbsp;&nbsp;用户名：<input id="keyword" type="text" name="keyword" class="combo" />
	           &nbsp;&nbsp;会员姓名：<input id="keyword" type="text" name="keyword" class="combo" />
            ...
            &nbsp;辅导人：<input id="fudaoren" type="text" name=""fudaoren"" class="combo" />
	           &nbsp; &nbsp;	          
