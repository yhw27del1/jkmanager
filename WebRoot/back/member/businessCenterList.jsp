...
<body>
	<form id="form1" action="/back/member/businessCenterAction!list"
		method="post">
		...
		<div id="myToolBar"
			...
			<div style="float: right; margin-right: 20px;">
				<button class="ui-state-default"
					onclick="toURL('/back/member/businessCenterAction!edit?modify=false');return false;"
                    style="display:<c:out value="${menuMap['businessCenter_edit']}"/>">
					新增
				</button>
				&nbsp;
			</div>
		...
		<div class="dataList ui-widget">
			<table class="ui-widget ui-widget-content">
				...
				<tbody class="table_solid">
					<c:forEach items="${pageView.records}" var="businesscenter">
						<tr>
							<td>
								${businesscenter.centerName}
							</td>
							<td>
								${businesscenter.code}
							</td>
							<td>
								<fmt:formatDate value="${businesscenter.createDate}" type="date" />
							</td>
							<td>
								<button class="ui-state-default"
									onclick="toURL('/back/member/businessCenterAction!edit?modify=true&id=${businesscenter.id}');return false;"
									style="display:<c:out value="${menuMap['businessCenter_edit']}" />">
									修改
								</button>
