...
function Submit_onclick(){
    if(window.top.document.getElementById('myFrame').cols == "199,7,*") {
        ...
        document.getElementById("ImgArrow").src="/wisdoorStatic/images/newtemplate/show.png";
        document.getElementById("ImgArrow").alt="打开左侧导航栏";
    } else {
        window.top.document.getElementById('myFrame').cols = "199,7,*";
        document.getElementById("ImgArrow").src="/wisdoorStatic/images/newtemplate/hold.png";
...
function MyLoad() {
    if(window.parent.location.href.indexOf("MainUrl")>0) {
        alert(1);
        window.top.midFrame.document.getElementById("ImgArrow").src="/wisdoorStatic/images/newtemplate/show.png";
    }
}
</script>
<body onload="MyLoad()">
