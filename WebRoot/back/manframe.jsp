...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>管理区域</title>
		<link rel="stylesheet" href="/wisdoorStatic/js/jquery.chromatable-1.3.0/css/style.css" type="text/css"/>
		<script type="text/javascript" src="/wisdoorStatic/js/jquery.chromatable-1.3.0/jquery-1.3.2.min.js"></script>
		<script type="text/javascript" src="/wisdoorStatic/js/jquery.chromatable-1.3.0/jquery-ui-1.7.2.custom.min.js"></script>
		<script type="text/javascript" src="/wisdoorStatic/js/jquery.chromatable-1.3.0/jquery.chromatable.js"></script>
		<script>
			$(function(){
				$("#tt").chromatable({
					width: "100%",
	...
	<ul class="dqlb">
		<c:forEach items="${dqlb_yuqi}" var="item">
			<li class="dqlb_yuqi">
				...
				<div>融资包编号:${item.financecode}</div>
				<div>融资包简称:${item.financename}</div>
