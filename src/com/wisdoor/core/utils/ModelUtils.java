...
public final class ModelUtils {
	...
	static {
		...
		modelNames.put("com.kmfex.model.FinancingBase", "确认后的融资包基本信息表");
		modelNames.put("com.kmfex.model.FinancingContract", "融资包总合同表");
		modelNames.put("com.kmfex.model.FinancingCost", "融资费用表");
		modelNames.put("com.kmfex.model.Industry", "公司行业表");
		modelNames.put("com.kmfex.model.InvestCondition", "投资申购约束表");
		modelNames.put("com.kmfex.model.InvestRecord", "投资申购记录表");
		modelNames.put("com.kmfex.model.InvestRecordCost", "投资申购费用明细表");
		...
		modelNames.put("com.kmfex.model.PreFinancingBase", "融资包申请历史表");
